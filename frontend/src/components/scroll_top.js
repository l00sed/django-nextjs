...
import scroll_styles from '../styles/ScrollTop.module.scss';
...
export default function ScrollTop() {
  ...
  return (
    <button id="scrollTop" type="button" title="Click to jump to the top of the page." className={ `${scroll_styles.scrollTop} hidden` } onClick={ scrollToTop }>
