      ...
      <section className={ footer_styles.link_section }>
        <div className={ footer_styles.link_row }>
          ...
          <div className={ footer_styles.link_col }>
            <h4>SOCIAL</h4>
            <div className={ footer_styles.link }>
              <Link href="https://github.com/l00sed" target="_blank" rel="noopener nofollow noreferrer">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="24"
                  height="24"
            ...
            <div className={ footer_styles.link }>
              <Link href="https://linkedin.com/in/dwtompkins" target="_blank" rel="noopener nofollow noreferrer">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
            ...
            <div className={ footer_styles.link }>
              <Link href="https://twitter.com/l00sed" target="_blank" rel="noopener nofollow noreferrer">
          ...
          <div className={ footer_styles.link_col }>
            ...
            <div className={ footer_styles.link }>
              <Link href="https://keybase.io/l00sed" target="_blank" rel="nofollow noopener noreferrer">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="24"
                  height="24"
